        ...
        <div className="space-y-4 sm:space-y-6">
            ...
            {results.answers.length === 0 && (
                <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md">
                    <p className="text-xs sm:text-sm text-yellow-700 dark:text-yellow-400">
                        No detailed question data available. Only total score is displayed.
                    </p>
                </div>
            )}
            ...
            {multipleChoiceAnswers.length > 0 && (
                <div className="mt-4 sm:mt-8">
                    <h4 className="text-sm sm:text-lg font-medium mb-2 sm:mb-4 dark:text-gray-200">
                        ...
                        {multipleChoiceAnswers.map((answer, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="border dark:border-gray-700 rounded-md p-3 sm:p-4 dark:bg-gray-900/40"
                                >
                                    <div className="flex items-start gap-2 sm:gap-3">
                                        ...
                                        <div className="flex-1">
                                            <h5 className="text-sm sm:text-base font-medium dark:text-gray-200">
                                ...
                                <div className="flex items-start gap-2 sm:gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 text-xs sm:text-sm">
                                            ...
                                            {answer.essayAnswer ? (
                                                <div className="p-2 bg-gray-50 dark:bg-slate-800 rounded border dark:border-slate-700 text-xs sm:text-sm">
                                                    {answer.essayAnswer}
                                                </div>
                                            ) : (
                                                <div className="text-gray-400 dark:text-gray-500 italic">
                                            ...
                                            {answer.modelAnswer && (
                                                <div className="mt-2 sm:mt-3">
                                                    ...
                                                    <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-100 dark:border-blue-800 text-xs sm:text-sm">
                                                        {answer.modelAnswer}
                                                    </div>
                                                </div>
                                            )}
