...
export const useScreenRecorder = () => {
    ...
    //                 } catch (e) {
    //                     console.error(
    //                         "Error disconnecting audio destination:",
    //                         e
    //                     );
    //                 }
    //             }
    ...
    //                 } catch (e) {
    //                     console.error(
    //                         `Error connecting audio source ${index}:`,
    //                         e
    //                     );
    //                 }
    //             });
    ...
    //                     } catch (e) {
    //                         console.error(
    //                             "Error adding combined audio track:",
    //                             e
    //                         );
    //                     }
    //                 });
    ...
    //             );
    //             toast.error(
    //                 "Không tìm thấy video để ghi lại, vui lòng kiểm tra lại"
    //             );
    ...
    //                     const isSpeaking =
    //                         container.classList.contains("speaking");
    //                     if (isSpeaking) {
    ...
    //                 toast.loading("Đang lưu dưới dạng WebM...", {
    //                     id: "saving-webm",
    //                 });
    ...
    //                 toast.error(
    //                     "Không thể chuyển đổi sang MP4, đã lưu dưới dạng WebM"
    //                 );
    //             } finally {
    //                 setIsProcessing(false);
    //                 setIsRecording(false);
    ...
    //         dataRequestIntervalRef.current =
    //             dataRequestInterval as unknown as number;
    ...
    //             toast.error(
    //                 "Không thể bắt đầu MediaRecorder: " +
    ...
    //         setIsProcessing(true);
    //         toast.loading("Đang dừng ghi và chuẩn bị video...", {
