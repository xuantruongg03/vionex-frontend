...
const Auth = () => {
            ...
            if (window.google && window.google.accounts) {
                try {
                    window.google.accounts.id.initialize({
                        ...
                        // Disable ITP optimization to avoid tracking issues
                        itp_support: false,
                        // Disable logging to avoid ERR_BLOCKED_BY_CLIENT
                        log_level: 'silent'
                    });
                } catch (error) {
    ...
    // Function to trigger Google login using Google Identity Services API
    const handleGoogleButtonClick = () => {
        try {
            if (window.google && window.google.accounts) {
                window.google.accounts.id.prompt();
            } else {
                // Fallback: Show GoogleLogin component
                setShowFallbackGoogle(true);
                toast.info("Using alternative Google Sign-In method...");
            }
        } catch (error) {
                                ...
                                {!showFallbackGoogle ? (
                                    ...
                                    <div className="w-full space-y-2">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => setShowFallbackGoogle(false)}
                                        >
