                        ...
                        <CardContent className='space-y-4 pt-0'>
                            ...
                            <div className='w-full'>
                                <Button
                                    type='button'
                                    variant='outline'
                                    className='w-full h-10 flex items-center justify-center gap-2 border-gray-300 hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-800'
                                    onClick={() => {
                                        // Trigger the hidden Google login by clicking the button inside it
                                        setTimeout(() => {
                                            const googleButton = (document.querySelector('div[role="button"][data-testid*="google"]') as HTMLElement) || (document.querySelector('div[role="button"]') as HTMLElement) || (document.querySelector(".google-login-hidden button") as HTMLElement);
                                            if (googleButton) {
                                                googleButton.click();
                                            }
                                        }, 100);
                                ...
                                >
                                    ...
                                    {isGoogleLoggingIn ? "Loading..." : "Sign In by Google"}
                                </Button>
                                {/* Hidden Google login component */}
                                <div className='google-login-hidden absolute opacity-0 pointer-events-none -z-10 w-0 h-0 overflow-hidden'>
                                    <GoogleLogin onSuccess={handleGoogleSuccess} onError={handleGoogleError} theme='outline' size='large' useOneTap={false} />
                                </div>
                            </div>
