    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <motion.div {...slideInLeft} className="space-y-8">
                            ...
                            >
                                <Badge className=" bg-gradient-to-r from-blue-600 to-purple-600 text-white border-0">
                                    🚀 New: AI-Powered Meeting Assistant
                                </Badge>
                            </motion.div>
                            ...
                            <motion.p
                                ...
                                className="text-xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed max-w-lg"
                            >
                                Experience next-generation video conferencing
                                with AI-powered features, crystal-clear 4K
                                quality, and enterprise-grade security that
                            ...
                            >
                                ...
                                >
                                    <Button
                                        size="lg"
                                        className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 h-14 px-8 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                                        asChild
                                    >
                                        <Link to={ROUTES.ROOM}>
                                ...
                                >
                                    <Button
                                        size="lg"
                                        variant="outline"
                                        className="h-14 px-8 text-lg font-semibold border-2 hover:bg-gray-50 dark:hover:bg-gray-800 dark:border-gray-600"
                                        asChild
                                    >
                        ...
                        <motion.div {...slideInRight} className="relative">
                            <div className="relative">
                                ...
                                >
                                    <img
                                        src="https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=700&h=500&fit=crop"
                                        alt="Professional video conference"
            ...
            <motion.section
                ...
                transition={{ duration: 0.6 }}
                viewport={{ once: true }}
                className="py-20 bg-white dark:bg-gray-900 border-y border-gray-100 dark:border-gray-800"
            >
                        ...
                        {data.stats.map((stat, index) => (
                            ...
                            >
                                <motion.div
                                    ...
                                    transition={{ duration: 0.5 }}
                                    className="bg-gradient-to-r from-blue-600 to-purple-600 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:shadow-lg transition-shadow duration-300"
                                >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <motion.div {...fadeInUp} className="text-center mb-20">
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                            From AI-powered features to enterprise-grade
                            security, VideoMeet provides all the tools you need
                            for productive and engaging video conferences.
                        </p>
                    </motion.div>
                    <motion.div
                        variants={staggerContainer}
                    ...
                    >
                        {data.features.map((feature, index) => (
                            ...
                            >
                                {" "}
                                <Card className="group h-full border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-500">
                                    <CardContent className="p-8">
                                        <motion.div
                                            ...
                                            transition={{ duration: 0.3 }}
                                            className={`bg-gradient-to-r ${feature.gradient} w-16 h-16 rounded-2xl flex items-center justify-center mb-6`}
                                        >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <motion.div {...fadeInUp} className="text-center mb-20">
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                            ...
                            our core features with advanced options for growing
                    ...
                    >
                        {pricingPlans.map((plan, index) => (
                            ...
                            >
                                {" "}
                                <Card
                                    className={`relative group h-full border-2 ${
                                        plan.popular
                                ...
                                >
                                    ...
                                    <CardContent
                                        className={`p-8 bg-gradient-to-br ${getGradient(
                                            plan
                                        )} group-hover:from-blue-50 group-hover:to-purple-50 dark:group-hover:from-blue-900/30 dark:group-hover:to-purple-900/30 transition-all duration-500`}
                                    >
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {" "}
                    <motion.div {...fadeInUp} className="text-center mb-20">
                        <Badge className="mb-6 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 border-green-200 dark:border-green-700">
                            💬 Customer Stories
                        </Badge>
                        <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300">
                            ...
                            VideoMeet for their daily communications.
                        </p>
                    </motion.div>
                    <motion.div
                        variants={staggerContainer}
            ...
            <motion.section
                ...
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
                className="py-24 bg-gradient-to-r from-blue-900 via-purple-900 to-pink-900 text-white relative overflow-hidden"
            >
                <motion.div
                    animate={{
                        scale: [1, 1.05, 1],
                ...
                <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <motion.p
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6, delay: 0.2 }}
                        className="text-xl text-blue-100 dark:text-blue-200 mb-10 max-w-3xl mx-auto"
                    >
                        Join millions of professionals who have already upgraded
                        their video conferencing experience. Start your free
                        trial today and see the difference quality makes.
                    </motion.p>
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
